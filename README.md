...
- HOG taajo trung vào cấu trúc, hình dạng của object. Điều này có thể được mô tả thông qua edge direction (hướng của biên), edge direction lại được xác định bởi độ lớn gradient (gradient magnitude) và hướng của gradient(gradient orientation)
